...
<div class="content-wrapper">
	...
	<section class="content-header">
	  <h1>
		<i class="fa fa-bookmark"></i> Kota
		<small>Kelola Kota</small>
	  </h1>
	  <ol class="breadcrumb">
		<li><a href="<?php echo site_url("administrator/home"); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
		<li><a href="<?php echo site_url("administrator/kota"); ?>"><i class="fa fa-truck"></i> Kota</a></li>
	  </ol>
	</section>
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
				<li class="active">
					<a href="#view_data" data-toggle="tab">
						<i class="fa fa-table"></i> Tabel Kota
					</a>
				</li>
                <li>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="view_data" >
					<table id="table_data" class="table table-bordered table-striped table-hover">
						...
						foreach($result_kota as $row){
							...
							<td>'.$n.'</td>
							<td>'.$row->nama_kota.'</td>
							<td>'.rupiah($row->biaya_pengiriman).'</td>
							<td>
							<center>
							<a href="'.site_url('administrator/kota_update/'.$row->kode_kota).'">
							<button class="btn btn-info update" title="Edit Data">
								<i class="fa fa-pencil"></i>
							</button>
							</a>
							<button class="btn btn-warning" id="call_del" data-whatever="'.$row->kode_kota.'" data-toggle="modal" data-target="#del_modal" title="Delete Data">
					  ...
					  <div class="modal-dialog">
						<div class="modal-content">
						  ...
						  <div class="modal-footer">
							<input type="hidden" class="link" value="<?php echo site_url('administrator/kota_delete_proses/');?>"/>
				...
				<div class="tab-pane" id="add_data">
					<form id="form_kota" method="POST" action="<?php echo site_url("administrator/kota_tambah_proses"); ?>">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="biaya_pengiriman" placeholder="Nama Kota" />
						</div>
